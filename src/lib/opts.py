...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='ctdet',
                             help='ctdet | ddd | multi_pose | exdet | saccadedet')
    ...
    self.parser.add_argument('--demo', default='data/voc/images',
    ...
    # model
    self.parser.add_argument('--arch', default='cspdarknet_53',
                             help='model architecture. Currently tested'
                                  'res_18 | res_101 | resdcn_18 | resdcn_101 | ressac_18'
                                  'dlav0_34 | dla_34 | cspdarknet_53')
    ...
    self.parser.add_argument('--cor_att_weight', type=np.float32, default=0.1,
  ...
  def parse(self, args=''):
    ...
    opt.root_dir = os.path.join('CenterM2')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 80,
                # 'mean': [0.50307721, 0.50307721, 0.50307721], 'std': [0.10507418, 0.10507418, 0.10507418],
